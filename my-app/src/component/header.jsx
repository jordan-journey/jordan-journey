    ...
    <div className="max-w-screen-xl px-4 py-3 mx-auto">
        <div className="flex items-center">
            <ul className="flex flex-row mt-0 space-x-8 text-sm font-medium rtl:space-x-reverse">
                <li>
                    <Link to="/" className="text-white dark:text-white hover:underline" aria-current="page">Home</Link>
                </li>
                <li>
                    <Link to="/ListingPage" className="text-white dark:text-white hover:underline">Discover</Link>
                </li>
                <li>
                    <Link to="/ContactUs" className="text-white dark:text-white hover:underline">Reach Out</Link>
                </li>
                <li>
                    <Link to="/AboutUs" className="text-white dark:text-white hover:underline">Our Story</Link>
                </li>
            </ul>
        </div>
    </div>
