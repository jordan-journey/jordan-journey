        ...
        {[...Array(totalPages)].map((_, index) => (
          <button
            ...
            className={`px-4 py-2 mx-2 text-sm font-medium text-white rounded-lg ${
              currentPage === index + 1 ? 'bg-green-700' : 'bg-green-600 hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-green-500 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-600'
            }`}
          >
            {index + 1}
          </button>
